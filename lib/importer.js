        ...
        return new Promise(function(resolve, reject) {
            ...
            .then(function(userSuccess) {
                return new Promise(function(resolve, reject) {
                    ...
                    if (mudData.data.characters !== undefined) {
                        mudData.data.characters.forEach(function(characterBlock) {
                            /*
                                TODO: Create character is really create NEW character. There's a lot more data that will need to be filled in.
                            */
                            characterTasks.push(lib.character.async.createCharacter(characterBlock.owner, characterBlock.name, characterBlock.room));
                        });
                    }
